...
(/** @lends <global> */function( $ ) {
	...
	function _fnBuildHead( oSettings )
	{
		...
		for ( i=0, ien=columns.length ; i<ien ; i++ ) {
			...
			_fnRenderer( oSettings, 'templates.include.old.header' )(
	...
	function _fnDraw( oSettings )
	{
		...
		_fnCallbackFire( oSettings, 'aoHeaderCallback', 'templates.include.old.header', [ $(oSettings.nTHead).children('tr')[0],
